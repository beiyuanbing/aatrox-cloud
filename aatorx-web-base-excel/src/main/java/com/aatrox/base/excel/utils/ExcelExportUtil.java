...
public class ExcelExportUtil {
    ...
    private boolean isIgnoreField(Field field) {
        return this.isTransient(field)||ignoreFieldList.contains(field.getName());
    }
    ...
    public ExcelExportUtil setIgnoreFieldList(List<String> ignoreFieldList) {
        this.ignoreFieldList = Optional.ofNullable(ignoreFieldList).orElse(new ArrayList<>());
        return this;
    }
}
